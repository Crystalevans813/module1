...
print(f"future_value and remaining_months is $ {future_value} and {remaining_months}")
...
for loan in loans:
    ...
    if loan["loan_price"] <= 500:
        inexpensive_loans.append(list(loan.values()))
print(f'inexpensive loans: {inexpensive_loans}')

# for line 203 google search: 
# 1. python dictionary.values()
# 2. python list()
# 3. python list.append() 
# 4. python for loop with if statement 
